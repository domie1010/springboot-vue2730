    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="取餐号" prop="shangpinOrderUuidNumber">
                       <el-input v-model="ruleForm.shangpinOrderUuidNumber"
                                 placeholder="取餐号" clearable  :readonly="ro.shangpinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="取餐号" prop="shangpinOrderUuidNumber">
                           <el-input v-model="ruleForm.shangpinOrderUuidNumber"
                                     placeholder="取餐号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            return {
                ...
                rules: {
                   shangpinOrderUuidNumber: [
                              { required: true, message: '取餐号不能为空', trigger: 'blur' },
                          ],
                   shangpinId: [
