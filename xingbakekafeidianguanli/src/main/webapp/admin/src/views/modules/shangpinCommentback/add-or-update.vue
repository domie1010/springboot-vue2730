    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品状态" prop="shangpinStateValue">
                        <el-input v-model="shangpinForm.shangpinStateValue"
                                  placeholder="商品状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品状态" prop="shangpinStateValue">
                            <el-input v-model="ruleForm.shangpinStateValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangpinCommentbackPhoto" label="评价图片" prop="shangpinCommentbackPhoto">
                        <file-upload
                            tip="点击上传评价图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shangpinCommentbackPhoto?ruleForm.shangpinCommentbackPhoto:''"
                            @change="shangpinCommentbackPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinCommentbackPhoto" label="评价图片" prop="shangpinCommentbackPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shangpinCommentbackPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shangpinId: false,
                    yonghuId: false,
                    shangpinCommentbackPhoto: false,
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinCommentbackPhoto'){
                          this.ruleForm.shangpinCommentbackPhoto = obj[o];
                          this.ro.shangpinCommentbackPhoto = true;
                          continue;
                      }
            ...
            //图片
            shangpinCommentbackPhotoUploadChange(fileUrls){
                this.ruleForm.shangpinCommentbackPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
