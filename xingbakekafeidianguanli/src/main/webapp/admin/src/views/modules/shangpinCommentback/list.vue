        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xingbakekafeidianguanli/upload/shangpinCommentbackMuBan.xls"
                        >批量导入商品评价数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinCommentback','导入导出')"
                                style="display: inline-block"
                                action="xingbakekafeidianguanli/file/upload"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="shangpinCommentbackPhoto"
                                     header-align="center"
                                     width="200"
                                     label="评价图片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.shangpinCommentbackPhoto">
                                <img :src="scope.row.shangpinCommentbackPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
