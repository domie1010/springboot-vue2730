        ...
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商品状态" prop="shangpinStateTypes">
                        <el-select v-model="ruleForm.shangpinStateTypes" placeholder="请选择商品状态">
                            <el-option
                                v-for="(item,index) in shangpinStateTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangpin_state_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangpinStateTypesOptions = data.data.list;
                    }
                });
                this.$http({
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinStateTypes'){
                          this.ruleForm.shangpinStateTypes = obj[o];
                          this.ro.shangpinStateTypes = true;
                          continue;
                      }
                      if(o=='shangpinPrice'){
